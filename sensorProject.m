...
y=[0.619	0.537	0.615	0.389	0.293	0.585;0.522	0.356	0.462	0.311	0.5	0.732;0.6	0.455	0.146	0.2	0.233	0.732];
...
%ylim([0,120]);
set(gca,'XTickLabel',[{'Sensor 1'},{'Sensor 2'},{'Sensor 3'},{'Sensor 4'},{'Sensor 5'},{'All 5 Sensors'}], 'FontSize', 14);
xticklabel_rotate([],45,[],'Fontsize',14); 

%leg=legend('UBCF','RANDOM','POPULAR','SVD','OmniSuggest','FontSize',10)  
leg=legend('Naive Bayes','SLR','SMO','FontSize',16); 
